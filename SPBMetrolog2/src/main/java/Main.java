...
public class Main
{
    ...
    private static final Marker WRONG_INPUT_STATION_MARKER = MarkerManager.getMarker("WRONG_INPUT_STATION");
    ...
    private static Station takeStation(String message)
    {
        for(;;)
        {
            ...
            if(station != null) {
                logger.info(INPUT_STATION_MARKER,"Искали станцию: " + line);
                return station;
            }
            logger.warn(WRONG_INPUT_STATION_MARKER, "Станция не найдена: " + line);
